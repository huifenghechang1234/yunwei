...
# cache path = True 表示开启缓存功能，短时间不用重新扫码
...
# 启用 ouid 属性，并指定 puid 所需的映射数据保存/载入路径， puid 可始终被获取到，且具有稳定的唯一性
bot.enable_puid("wxpy puid.pkl")
...
# 以动态的方式发送图片
my_friend.send("@img@myicture.png")
...
# 搜索名称包含，三人行，且成员中包含my friend’的群聊对象
