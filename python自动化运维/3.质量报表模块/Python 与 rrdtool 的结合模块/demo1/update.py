...
update = rrdtool.updatev('/python_program/python自动化运维/3.质量报表模块/Python 与 rrdtool 的结合模块/demo1/Flow.rrd',
...
python
update = rrdtool.updatev('/python_program/python自动化运维/3.质量报表模块/Python 与 rrdtool 的结合模块
/demo1/Flow.rrd',  
