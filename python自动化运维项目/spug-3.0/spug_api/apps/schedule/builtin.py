...
from spug_api.apps.account.models import History, User
from spug_api.apps.alarm.models import Alarm
from spug_api.apps.schedule.models import Task, History as TaskHistory
from spug_api.apps.deploy.models import DeployRequest
from spug_api.apps.app.models import DeployExtend1
from spug_api.apps.exec.models import ExecHistory, Transfer
from spug_api.apps.notify.models import Notify
from spug_api.apps.deploy.utils import dispatch
from spug_api.apps.repository.models import Repository
from spug_api.libs.utils import parse_time, human_datetime, human_date
